...
interface LinkedinImageOverlayProps {
  form: UseFormReturn<ArticleFormData>;
  watchTitle: string;
}

export const LinkedinImageOverlay = ({ form, watchTitle }: LinkedinImageOverlayProps) => {
  const generateLinkedinImageText = () => {
    ...
    form.setValue("linkedin_image_text", imageText);
  };
        ...
        render={({ field }) => (
          <FormItem>
            <div className="flex justify-between items-center">
              ...
              <button
                type="button"
                onClick={generateLinkedinImageText}
            ...
            <FormDescription>
              Short text that will appear on the LinkedIn image
            </FormDescription>
          </FormItem>
        )}
      />
