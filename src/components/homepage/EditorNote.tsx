      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gray-50 rounded-xl p-8 md:p-12">
          <div className="text-center">
            <h3 className="text-sm font-light text-gray-600 uppercase tracking-wide mb-4">
              Editor's Note
            </h3>
            <blockquote className="text-xl md:text-2xl font-light text-gray-900 leading-relaxed tracking-wide mb-6">
            ...
            <footer className="text-gray-600">
              <cite className="font-light tracking-wide">Kwame Asante</cite>
