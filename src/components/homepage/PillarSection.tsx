    ...
    <div className="border-t border-gray-100 pt-12">
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-1">
          ...
          <p className="text-gray-600 leading-relaxed font-light tracking-wide mb-6">
            {pillar.description}
          </p>
          <Link 
                ...
                <article className="group cursor-pointer">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <h4 className="text-lg font-light text-gray-900 leading-tight group-hover:text-gray-700 transition-colors tracking-wide">
                        {article.title}
                      </h4>
